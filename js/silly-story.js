...
function result() {
    ...
    var xItem = randomValueFromArray(insertX); // STEP 8
    ...
    newStory = newStory.replace(':insertx:', xItem).replace(':insertx:', xItem); // STEP 9
